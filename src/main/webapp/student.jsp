	...
	<div style="height: 5%">
		<form name="searchform" method="post" id ="searchform">
			...
			性别：<select name="qsex" id="qsex"  class="easyui-combobox">
		        ...
		        <input class="easyui-filebox"data-options="buttonText:'选择文件'" style="width:300px;">
		        <a id="import_btn" href="#" class="easyui-linkbutton" data-options="iconCls:'icon-ok'">导入</a>
		        <a id="export_btn" href="#" class="easyui-linkbutton" data-options="iconCls:'icon-ok'">到出</a>
	  	</form>
  	</div>
  	<div style="height: 95%">
